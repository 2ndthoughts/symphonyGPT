...
class AdeDrugEffectTokenClassifier(AutoTokenClassifier):

    def __init__(self):
        super().__init__("token-classification")
        self.model = "chintagunta85/electramed-small-ADE-DRUG-EFFECT-ner-v3"
